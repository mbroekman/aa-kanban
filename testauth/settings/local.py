...
# to https://industry.com/sso/callback
# substituting your domain for industry.com
...
ESI_USER_CONTACT_EMAIL = "dummy@industry.net"
...
# Set the default from email to something like 'noreply@industry.com'
